...
class BaseTrainingModule(pl.LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        # Exclude model_config from hparams: OmegaConf calls typing.get_type_hints on it
        # during serialization, which fails when annotations reference torch without an import.
        # Re-inject model_config in on_save_checkpoint instead.
    ...
    def on_save_checkpoint(self, checkpoint: dict) -> None:
        """Re-inject model_config that was excluded from save_hyperparameters."""
